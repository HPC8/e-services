    ...
    <div class="col-xs-12">
        ...
        <div>
            <table id="tbl-layout-25" class="table table-striped table-bordered table-hover display nowrap"
                ...
                <tbody>
                    <?php $no=1; foreach ($cateInfo as $rs) { ?>
                    <tr>
                        <td class="center">
                            <?php echo  $no;?>
                        </td>
                        ...
                        <td class="center">
                            <div class="hidden-xs btn-group">
                                ...
                                <a title="Delete" href="javascript:void(0);" data-getcode="<?php echo $rs->hospcode;?>"
                                    data-toggle="modal" data-target="#discard-emp"
                                    class="discard-emp-details btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                            </div>
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <a title="Delete" href="javascript:void(0);"
                                                data-getcode="<?php echo $rs->hospcode;?>" data-toggle="modal"
                                                data-target="#discard-emp"
                                                class="discard-emp-details btn btn-danger btn-xs"><i
...
<a title="View" href="javascript:void(0);" id="view-alerts-auto" data-getview="" data-toggle="modal"
    data-target="#view-alerts"></a>
<?php }
    }elseif($this->session->userdata('msg')=='0'){?>
<a title="View" href="javascript:void(0);" id="view-success-auto" data-getview="" data-toggle="modal"
...
<?php
    ...
    $this->load->view('employee/popup/discard');
?>