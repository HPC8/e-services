                                ...
                                <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-value">
                                        <div class="input-group col-xs-12">
                                            <select class="form-control input-sm" name="inputstatus" id="inputstatus" required>
                                                <!-- <?php 
                                                    ...
                                                    <?php foreach ($status as $row) { ?>
                                                            <option <?php if($row->id == $data['meeting_status']){ echo 'selected="selected"'; } ?> value="<?php echo $row->id ?>"><?php echo $row->name ?> </option>
                                                        <?php } ?>
                                            </select>
                                        </div>
                                    </div>
