<div class="modal fade rotate" id="del-trainuser" style="display:none;">
    <div class="modal-dialog modal-sm">
        <form id="del-trainuser-form" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-sm btn-success btn-round" data-deleteid=""
                                id="del-trainuser-id"><i class="ace-icon fa fa-check-square-o bigger-125"></i>ตกลง</button>
