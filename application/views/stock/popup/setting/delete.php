<div class="modal fade rotate" id="delete-stock" style="display:none;">
    <div class="modal-dialog modal-sm">
        <form id="delete-stock-form" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-sm btn-success btn-round" data-deleteid=""
                                id="delete-stock-id"><i class="ace-icon fa fa-check-square-o bigger-125"></i>ตกลง</button>
