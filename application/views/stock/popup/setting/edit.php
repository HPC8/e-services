<div class="modal fade rotate" id="update-stock" style="display:none;">
    <div class="modal-dialog" >
        <form id="update-stock-form" method="post">
            <div class="modal-content panel panel-default">
                ...
                <div class="modal-body panel-body" id="render-update-stock">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-sm btn-success btn-round" data-editid=""
                                id="update-stock"><i class="ace-icon fa fa-floppy-o bigger-125"></i>บันทึก</button>
