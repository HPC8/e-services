<div class="modal fade rotate" id="update-repairing" style="display:none;">
    <div class="modal-dialog modal-xl" >
        <form id="update-repairing-form" method="post">
            <div class="modal-content panel panel-default">
                <div class="modal-header panel-heading">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title -remove-title"><i class="ace-icon fa fa-pencil-square-o"> แก้ไข</i></h4>
                </div>
                <div class="modal-body panel-body" id="render-update-repairing">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-sm btn-success btn-round" data-addproductid=""
                                id="update-repairing"><i class="ace-icon fa fa-floppy-o bigger-125"></i>บันทึก</button>
