                ...
                <div class="profile-user-info profile-user-info-striped">
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">
                            ...
                            <input type="hidden" id="edit-id" class="form-control input-edit-id"
                                name="edit_id" value="<?php echo $data->id;?>">
                        </div>
                    </div>
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">
                            <div class="radio radio-success radio-inline">
                                <input type="radio" id="inlineRadio1" value="2" name="inputstatus" checked
                                    <?php if($data->status == '2' ) { echo 'checked'; } ?>>
                ...
                <table id="tbl-layout-10" class="table table-striped table-bordered table-hover display nowrap"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="50%" class="center">ชื่อครุภัณฑ์</th>
                            <th width="10%" class="center">จำนวน</th>
                            <th width="10%" class="center">หน่วย</th>
                            <th width="25%" class="center">เลขครุภัณฑ์</th>
                        </tr>
                    </thead>
                    <tbody>
