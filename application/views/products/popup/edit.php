<div class="modal fade rotate" id="update-products" style="display:none;">
    <div class="modal-dialog modal-xl" >
        <form id="update-products-form" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-sm btn-success btn-round" data-addproductid=""
                                id="update-products"><i class="ace-icon fa fa-floppy-o bigger-125"></i>บันทึก</button>
