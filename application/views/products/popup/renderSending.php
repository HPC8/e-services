    ...
    <div class="col-sm-12">
        <div class="widget-box widget-color-blue">
            <div class="widget-header">
                ...
                <span class="label label-warning arrowed arrowed-right">การนำจ่าย <i class="ace-icon fa fa-paper-plane-o bigger-120"></i></span>
            </div>
            <div class="row">
                <div class="profile-user-info profile-user-info-striped">
                    <div class="profile-info-row">
                        ...
                        <div class="profile-info-value">
                            <span class="editable"><?php echo $data->order_doc;?></span>
                ...
                <table id="tbl-layout-10" class="table table-striped table-bordered table-hover display nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="center">
                                <select class="chosen-select multiple_selection form-control" name="serial_no[]"
                                    multiple="multiple" data-placeholder="กรุณาเลือก">
                                    <?php 
            							foreach($serial_no as $row){
                                            if($row->product_id==$item->product_id){
                                                echo '<option value="'.$item->product_id.'-'.$row->serial_text.'">'.$row->serial_text.'</option>';
                                            } 
            							}
            						?>
                                </select>
