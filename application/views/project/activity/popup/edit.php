<div class="modal fade rotate" id="update-activity" style="display:none;">
    <div class="modal-dialog modal-lg"> //modal-lg
        <form id="update-activity-form" method="post">
            <div class="modal-content panel panel-default">
                ...
                <div class="modal-body panel-body" id="render-update-activity">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-sm btn-success btn-round" data-addempid=""
                                id="update-activity"><i class="ace-icon fa fa-floppy-o bigger-125"></i>บันทึก</button>
