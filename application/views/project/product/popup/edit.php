<div class="modal fade rotate" id="update-product" style="display:none;">
    <div class="modal-dialog modal-lg"> //modal-lg
        <form id="update-product-form" method="post">
            <div class="modal-content panel panel-default">
                ...
                <div class="modal-body panel-body" id="render-update-product">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-sm btn-success btn-round" data-addempid=""
                                id="update-product"><i class="ace-icon fa fa-floppy-o bigger-125"></i>บันทึก</button>
