<div class="modal fade rotate" id="delete-product" style="display:none;">
        ...
        <form id="delete-product-form" method="post">
            <div class="modal-content panel panel-warning">
                ...
                <div class="modal-footer panel-footer">
                    <div class="row">
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-sm btn-success btn-round" data-productid=""
                                id="delete-product-id"><i class="ace-icon fa fa-check-square-o bigger-125"></i>ตกลง</button>
