...
//         }
        ...
        function count_meeting($meeting_room, $book_start, $book_end) {
            $query=$this->db->query("SELECT id FROM tbl_meeting_book WHERE meeting_room='$meeting_room' AND meeting_status < '3'
AND ((book_start BETWEEN '$book_start'AND '$book_end') OR (book_end BETWEEN '$book_start'AND '$book_end') OR ('$book_start'BETWEEN book_start AND book_end) OR ('$book_end'BETWEEN book_start AND book_end))");
return $query->num_rows();
            }
